        ...
        <tr v-for="category in categories" :key="category.id">
          ...
          <td class="btn-group d-flex flex-row justify-content-center">
            <button
              ...
              @click="editarDados(category.title, category.url, category.description,category.id)"
            >
...
export default {
  ...
  methods: {
    ...
    createCategory() {
      ...
      window.axios
        .post("/api/v1/categories", this.sendData)
        .then((res) => {
          Vue.$toast.open({
    ...
    deletar(id) {
      window.axios
        .delete("/api/v1/categories/" + id, this.sendData)
        .then((res) => {
          Vue.$toast.open({
